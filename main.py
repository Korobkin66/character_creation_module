...
def attack(char_name: str, char_class: str) -> str:
    """Show result of attack according to chozen character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Show defence result according to chozen character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Show special skill according to chozen character."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Prompt the player to perform various actions with the character.
    Also describing its features.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """
    Ask witch character do player want to play for.
